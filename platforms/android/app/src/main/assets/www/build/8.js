...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__cadastrar_usuario__ = __webpack_require__(564);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(105);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_user_user__ = __webpack_require__(348);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CadastrarUsuarioPage = /** @class */ (function () {
    ...
    CadastrarUsuarioPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-cadastrar-usuario',template:/*ion-inline-start:"C:\Users\tiago\OneDrive\Documentos\Documentos\ProjetosIonic\IonicAppClinica\src\pages\cadastrar-usuario\cadastrar-usuario.html"*/'<ion-header>\n  <ion-navbar transparent>\n    <ion-title>Cadastrar Usuário</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding class="conteudo">\n\n  <ion-grid class="grid-logo">\n    <ion-row align-items-center justify-content-center>\n      <ion-col col-12 align-self-center>\n        <img src="../../assets/imgs/logo.png" />        \n      </ion-col>\n    </ion-row>\n  </ion-grid>\n  \n\n  <ion-grid class="grid-list">\n    <ion-row align-items-center justify-content-center>\n      <ion-col align-self-center col-12 col-lg-4 col-xl-4>\n\n        <ion-list class="conteudo-input">\n\n          <ion-item class="margem-input-top">\n            <ion-input type="text" [(ngModel)]="usuarios.nomeUsuario" placeholder="Nome"></ion-input>\n          </ion-item>\n\n          <ion-item class="margem-input-top">\n            <ion-input type="text" [(ngModel)]="usuarios.email" placeholder="E-mail"></ion-input>\n          </ion-item>\n        \n          <ion-item class="margem-input-top">\n            <ion-input type="password" [(ngModel)]="usuarios.senha" placeholder="Senha"></ion-input>\n          </ion-item>\n\n          <button ion-button block color="vinho" (click)="cadastrar()" class="margem-btn-top btn">Cadastrar</button>\n        \n        </ion-list>\n\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n\n</ion-content>'/*ion-inline-end:"C:\Users\tiago\OneDrive\Documentos\Documentos\ProjetosIonic\IonicAppClinica\src\pages\cadastrar-usuario\cadastrar-usuario.html"*/,
        }),

...
var ClinicasListPage = /** @class */ (function () {
    ...
    ClinicasListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-clinicas-list',template:/*ion-inline-start:"C:\Users\tiago\OneDrive\Documentos\Documentos\IonicAppMedicalClinic\src\pages\clinicas-list\clinicas-list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Lista de clinicas</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n  \n    <ion-item *ngFor="let item of clinicas" (click)="editClinica(item)">\n     \n      <h2>Clinica: {{item.value.nome}}</h2>\n      <p>Endereço: {{item.value.endereco}}</p>\n      <p>{{item.value.cidade}} - {{item.value.UF}}</p>\n    </ion-item>\n  \n  <ion-fab right bottom>\n    <button ion-fab mini (click)="cadastroClinica()"><ion-icon name="add" ></ion-icon></button>\n  </ion-fab>\n\n</ion-content>\n'/*ion-inline-end:"C:\Users\tiago\OneDrive\Documentos\Documentos\IonicAppMedicalClinic\src\pages\clinicas-list\clinicas-list.html"*/,
        }),

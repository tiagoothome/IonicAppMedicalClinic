...
var MedicosListPage = /** @class */ (function () {
    ...
    MedicosListPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-medicos-list',template:/*ion-inline-start:"C:\Users\tiago\OneDrive\Documentos\Documentos\IonicAppMedicalClinic\src\pages\medicos-list\medicos-list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Lista de médicos</ion-title>\n  </ion-navbar>\n</ion-header>\n\n\n<ion-content padding>\n  \n    <ion-item *ngFor="let item of medicos" (click)="editMedico(item)">\n     \n      <h2>Médico: {{item.value.nome}}</h2>\n      <p>CRM: {{item.value.crm}}</p>\n      <p>telefone: {{item.value.telefone}} -    status: {{item.value.status}}</p>\n    </ion-item>\n  \n  <ion-fab right bottom>\n    <button ion-fab mini (click)="cadastroMedico()"><ion-icon name="add" ></ion-icon></button>\n  </ion-fab>\n\n</ion-content>\n'/*ion-inline-end:"C:\Users\tiago\OneDrive\Documentos\Documentos\IonicAppMedicalClinic\src\pages\medicos-list\medicos-list.html"*/,
        }),
